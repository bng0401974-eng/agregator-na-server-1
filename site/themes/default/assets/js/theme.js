    ...
    $("body").on("click", "[data-action]", function(e) {
      ...
      switch (action) {
        ...
        case "offcanvas-close":
          $target.removeClass("open").attr("aria-hidden", "true");
          $("[data-action='offcanvas-open'][data-target='" + target + "']").attr("aria-expanded", "false");
          $("body").find(".body-backdrop[data-target='" + target + "']").remove();
